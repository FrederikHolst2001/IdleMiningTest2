import { ConnectEmbed, WalletConnect, useAddress, useSDK, useShowConnectEmbed, useUser, useWallet } from "@thirdweb-dev/react";
...
const Login = () => {
    ...
    const checkNewPlayer = async () => {
        try {
            ...
            if(wallet instanceof WalletConnect && address && sdk) {
